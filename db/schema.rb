...
ActiveRecord::Schema.define(version: 20140513013321) do
  ...
  add_index "message_threads", ["user_one"], name: "index_message_threads_on_user_one", using: :btree
  add_index "message_threads", ["user_two"], name: "index_message_threads_on_user_two", using: :btree
